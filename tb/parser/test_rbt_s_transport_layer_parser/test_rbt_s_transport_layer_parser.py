...
async def run_test_full(dut, payload_lengths=None, payload_data=None, idle_inserter=None, backpressure_inserter=None):
    ...
    for payload in [payload_data(x) for x in payload_lengths()]:
        ...
        seasp = raw([0x03,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x20,0x00,0x80,0x00,0x00,0x00,0x00,0x00,0x00,
        ...
        # phv_w_out[RSIP1_NO] = 0xaabbbbbb #
        # phv_w_out[RSIP2_NO] = 0x00aaaaaa #
        # phv_w_out[RSIP3_NO] = 0x00000000 #
        # phv_w_out[RSIP4_NO] = 0x20008000 #
        # phv_w_out[RPN_NO] =   0xbbcccccc #
